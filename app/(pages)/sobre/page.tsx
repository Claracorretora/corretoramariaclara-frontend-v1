...
export default function AboutPage() {
  const stats = [
    ...
    {
      icon: <Tag className="w-8 h-8 text-amber-400" />,
      value: "100%",
  ...
  return (
    <section className="w-full bg-white max-w-7xl mx-auto">
      <div className="relative md:grid md:grid-cols-12 w-full">
        ...
        <div className="relative md:col-span-9 flex items-center md:bg-gray-50 h-full md:rounded-br-sm">
          <div className="hidden md:block absolute inset-0 z-0">
            <Image
              src={image}
              alt="Interior de imóvel luxuoso"
              fill
              className="object-cover md:rounded-br-sm"
            />
